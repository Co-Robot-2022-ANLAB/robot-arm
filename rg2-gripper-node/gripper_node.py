...
class GripperNode:
	...
	elif data.data == 'highvoltage':
	    self.gripper.set_voltage_24()
	elif data.data == 'middlevoltage':
	    self.gripper.set_voltage_12()
	elif data.data == 'lowvoltage':
	    self.gripper.set_voltage_0()
