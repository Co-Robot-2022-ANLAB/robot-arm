...
while not rospy.is_shutdown():  
  if(xx%2 == 1):        
    ...
    pose_goal.position.x = 0.44 # red line      0.2   0.2
    pose_goal.position.y = 0.2  # green line  0.15   0.15
    pose_goal.position.z = 0.44  # blue line   # 0.35   0.6
    ...
    pose_goal.orientation.w = 0.0
    pose_goal.position.x = 0.45 # red line      0.2   0.2
    pose_goal.position.y = 0.2  # green line  0.15   0.15
    pose_goal.position.z = 0.05  # blue line   # 0.35   0.6
    group[0].set_pose_target(pose_goal)
    group[0].go(True)
